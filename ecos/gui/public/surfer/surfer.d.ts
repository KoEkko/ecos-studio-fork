 ...
 */
export function get_state(): Promise<string | undefined>;
...
export interface InitOutput {
    ...
    readonly wasm_bindgen__closure__destroy__h2ea992ce6b8ab705: (a: number, b: number) => void;
    readonly wasm_bindgen__convert__closures_____invoke__he298c532648f9a59: (a: number, b: number, c: any) => [number, number];
    readonly wasm_bindgen__convert__closures_____invoke__h4e2a290f246da38e: (a: number, b: number, c: any, d: any) => void;
    readonly wasm_bindgen__convert__closures_____invoke__h1a2ad7f1409c1692: (a: number, b: number, c: any) => void;
    readonly wasm_bindgen__convert__closures_____invoke__h1a2ad7f1409c1692_2: (a: number, b: number, c: any) => void;
    readonly wasm_bindgen__convert__closures_____invoke__hb4af6b168760d85c: (a: number, b: number) => [number, number];
    readonly wasm_bindgen__convert__closures_____invoke__h18a0ab15ab0d6314: (a: number, b: number) => void;
